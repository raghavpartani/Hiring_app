...
public class RejectMatchesActivity extends AppCompatActivity implements NavigationView.OnNavigationItemSelectedListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mMatchesLayoutManager = new LinearLayoutManager(RejectMatchesActivity.this);
        mRecyclerView.setLayoutManager(mMatchesLayoutManager);
        mMatchesAdapter = new RejectMatchesAdapter(getDatasetMatches(), RejectMatchesActivity.this);
            ...
            public boolean onNavigationItemSelected(@NonNull MenuItem item) {
                switch (item.getItemId()) {
                    case R.id.mainactivityitem1:
                        Intent in = new Intent(RejectMatchesActivity.this,MainActivity.class);
                        startActivity(in);
                        finish();;
                        break;
                    case R.id.matchactivtyitem1:
                        Toast.makeText(RejectMatchesActivity.this, "You are in Rejected", Toast.LENGTH_SHORT).show();
                        break;
                }
                return true;
            }
    ...
    public boolean onNavigationItemSelected(@NonNull MenuItem item) {
        if (item.getItemId() == R.id.settings) {
            Intent intent = new Intent(RejectMatchesActivity.this, SettingsActivity.class);
            //intent.putExtra("userSex",userSex);
            startActivity(intent);
        }
        if (item.getItemId() == R.id.Map) {
            Intent in = new Intent(RejectMatchesActivity.this, mapactivity.class);
            startActivity(in);
        }
